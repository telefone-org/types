...
class APIMethods:
    ...
    async def copy_message(
        ...
        **kwargs
        ...
        copied message doesn't have a link to the original message. Returns the MessageId of
    ...
    async def get_chat_administrators(
        ...
        """
        Use this method to get a list of administrators in a chat. On success, returns an
        Array of ChatMember objects that contains information about all chat administrators
    ...
    async def set_my_commands(
        ...
        **kwargs
        ...
        https://core.telegram.org/bots#commands for more details about bot commands. Returns
        True on success.
        """
    ...
    async def delete_message(
        ...
        **kwargs
        ...
        hours ago. - Bots can delete outgoing messages in private chats, groups, and
    ...
    async def get_game_high_scores(
        ...
        **kwargs
        ...
        target user, plus two of their closest neighbors on each side. Will also return the
        top three users if the user and their neighbors are not among them. Please note that
